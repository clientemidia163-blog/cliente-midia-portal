...
export default async function DiagnosticoPage() {
  ...
  return (
    <PillarPage
      ...
      articles={articles}
      fallbackArticles={[
        { tag: "Em produção", title: "O verdadeiro custo do CAC no varejo de moda em 2026.", subtitle: "Análise das margens, da inflação dos leilões e do que cada novo cliente realmente custa hoje no Brasil.", meta: "Previsto · Maio 2026" },
